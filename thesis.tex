...
\chapter{Biomechanical model of the breast -  state of the art}\label{chapter:bioMecaModelsBackground}
...
\chapter{ Breast Compression - state of the art }\label{chapter:compression:introduction}
\input{chapters/compression}

\chapter{Breast compression and patient comfort: a comparative study}\label{chapter:compressionfem}
